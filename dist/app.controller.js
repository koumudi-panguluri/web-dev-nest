...
let AppController = class AppController {
    ...
    async getCategoryData(category) {
        try {
            ...
            throw new common_1.HttpException("Could not get Past History", common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
};
...
], AppController.prototype, "getCategoryData", null);
exports.AppController = AppController = __decorate([
    (0, swagger_1.ApiTags)('Web'),
